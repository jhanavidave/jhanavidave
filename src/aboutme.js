  ...
  return (
    <div>
      ...
      <p id="spacing" align="justify">
        ...
        <p>
          <ul>
            <li><b>Tendency to Overcommit:</b> My eagerness to help sometimes leads to overcommitting, but I’m learning to prioritize better.</li>
            <li><b>Public Speaking:</b> WWhile I'm comfortable in small groups, I’m working on building confidence for larger presentations.</li>
            <li><b>Overthinking:</b> I tend to overanalyze but am focusing on making quicker, more decisive decisions.</li>
            <li><b>Self-Criticism:</b> I set high standards for myself and am learning to view mistakes as growth opportunities.</li>
            <li><b>Difficulty Saying "No":</b>  I struggle with setting boundaries but am improving to avoid burnout.</li>
          </ul>
        </p>
